...
@InputType()
export class MultipleChoiceQuestionUpdateManyWithoutMultipleQuestionsInput {

    @Field(() => [MultipleChoiceQuestionCreateWithoutMultipleQuestionsInput], {nullable:true})
    create?: Array<MultipleChoiceQuestionCreateWithoutMultipleQuestionsInput>;

    @Field(() => [MultipleChoiceQuestionCreateOrConnectWithoutMultipleQuestionsInput], {nullable:true})
    connectOrCreate?: Array<MultipleChoiceQuestionCreateOrConnectWithoutMultipleQuestionsInput>;

    @Field(() => [MultipleChoiceQuestionUpsertWithWhereUniqueWithoutMultipleQuestionsInput], {nullable:true})
    upsert?: Array<MultipleChoiceQuestionUpsertWithWhereUniqueWithoutMultipleQuestionsInput>;

    @Field(() => MultipleChoiceQuestionCreateManyMultipleQuestionsInputEnvelope, {nullable:true})
    ...
    @Field(() => [MultipleChoiceQuestionUpdateWithWhereUniqueWithoutMultipleQuestionsInput], {nullable:true})
    update?: Array<MultipleChoiceQuestionUpdateWithWhereUniqueWithoutMultipleQuestionsInput>;

    @Field(() => [MultipleChoiceQuestionUpdateManyWithWhereWithoutMultipleQuestionsInput], {nullable:true})
