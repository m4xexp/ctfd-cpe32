...
export class MultipleQuestionsUpdateOneRequiredWithoutMultipleChoiceQuestionInput {
    ...
    @Field(() => MultipleQuestionsUpsertWithoutMultipleChoiceQuestionInput, {nullable:true})
    ...
    @Field(() => MultipleQuestionsUpdateWithoutMultipleChoiceQuestionInput, {nullable:true})
