...
@InputType()
export class MultipleQuestionsUncheckedCreateWithoutChallengesInput {
    ...
    @Field(() => MultipleChoiceQuestionUncheckedCreateNestedManyWithoutMultipleQuestionsInput, {nullable:true})
