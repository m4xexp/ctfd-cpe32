...
export class MultipleQuestionsUpdateInput {
    ...
    @Field(() => ChallengesUpdateOneRequiredWithoutMultipleQuestionsInput, {nullable:true})
    challenges?: ChallengesUpdateOneRequiredWithoutMultipleQuestionsInput;

    @Field(() => MultipleChoiceQuestionUpdateManyWithoutMultipleQuestionsInput, {nullable:true})
