...
@InputType()
export class MultipleQuestionsUpdateManyWithoutChallengesInput {
    ...
    @Field(() => [MultipleQuestionsUpsertWithWhereUniqueWithoutChallengesInput], {nullable:true})
    ...
    @Field(() => [MultipleQuestionsUpdateWithWhereUniqueWithoutChallengesInput], {nullable:true})
    update?: Array<MultipleQuestionsUpdateWithWhereUniqueWithoutChallengesInput>;

    @Field(() => [MultipleQuestionsUpdateManyWithWhereWithoutChallengesInput], {nullable:true})
