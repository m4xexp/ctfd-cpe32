...
@InputType()
export class TutorialChapterDatasUpdateManyWithoutTutorialContentsInput {

    @Field(() => [TutorialChapterDatasCreateWithoutTutorialContentsInput], {nullable:true})
    create?: Array<TutorialChapterDatasCreateWithoutTutorialContentsInput>;

    @Field(() => [TutorialChapterDatasCreateOrConnectWithoutTutorialContentsInput], {nullable:true})
    connectOrCreate?: Array<TutorialChapterDatasCreateOrConnectWithoutTutorialContentsInput>;

    @Field(() => [TutorialChapterDatasUpsertWithWhereUniqueWithoutTutorialContentsInput], {nullable:true})
    upsert?: Array<TutorialChapterDatasUpsertWithWhereUniqueWithoutTutorialContentsInput>;

    @Field(() => TutorialChapterDatasCreateManyTutorialContentsInputEnvelope, {nullable:true})
    ...
    @Field(() => [TutorialChapterDatasUpdateWithWhereUniqueWithoutTutorialContentsInput], {nullable:true})
    update?: Array<TutorialChapterDatasUpdateWithWhereUniqueWithoutTutorialContentsInput>;

    @Field(() => [TutorialChapterDatasUpdateManyWithWhereWithoutTutorialContentsInput], {nullable:true})
