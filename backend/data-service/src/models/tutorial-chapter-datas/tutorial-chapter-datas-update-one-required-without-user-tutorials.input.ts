...
export class TutorialChapterDatasUpdateOneRequiredWithoutUserTutorialsInput {
    ...
    @Field(() => TutorialChapterDatasCreateWithoutUserTutorialsInput, {nullable:true})
    create?: TutorialChapterDatasCreateWithoutUserTutorialsInput;

    @Field(() => TutorialChapterDatasCreateOrConnectWithoutUserTutorialsInput, {nullable:true})
    connectOrCreate?: TutorialChapterDatasCreateOrConnectWithoutUserTutorialsInput;

    @Field(() => TutorialChapterDatasUpsertWithoutUserTutorialsInput, {nullable:true})
    ...
    @Field(() => TutorialChapterDatasUpdateWithoutUserTutorialsInput, {nullable:true})
