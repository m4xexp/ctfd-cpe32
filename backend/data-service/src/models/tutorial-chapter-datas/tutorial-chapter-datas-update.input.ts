...
export class TutorialChapterDatasUpdateInput {
    ...
    @Field(() => TutorialContentsUpdateOneRequiredWithoutTutorialChapterDatasInput, {nullable:true})
    tutorialContents?: TutorialContentsUpdateOneRequiredWithoutTutorialChapterDatasInput;

    @Field(() => UserTutorialsUpdateManyWithoutTutorialChapterDatasInput, {nullable:true})
