...
export class TutorialContentsUpdateOneRequiredWithoutTutorialChapterDatasInput {
    ...
    @Field(() => TutorialContentsCreateWithoutTutorialChapterDatasInput, {nullable:true})
    create?: TutorialContentsCreateWithoutTutorialChapterDatasInput;

    @Field(() => TutorialContentsCreateOrConnectWithoutTutorialChapterDatasInput, {nullable:true})
    connectOrCreate?: TutorialContentsCreateOrConnectWithoutTutorialChapterDatasInput;

    @Field(() => TutorialContentsUpsertWithoutTutorialChapterDatasInput, {nullable:true})
    ...
    @Field(() => TutorialContentsUpdateWithoutTutorialChapterDatasInput, {nullable:true})
