...
@InputType()
export class EventsUncheckedUpdateManyWithoutBadgesInput {
    ...
    @Field(() => [EventsUpsertWithWhereUniqueWithoutBadgesInput], {nullable:true})
    ...
    @Field(() => [EventsUpdateWithWhereUniqueWithoutBadgesInput], {nullable:true})
    update?: Array<EventsUpdateWithWhereUniqueWithoutBadgesInput>;

    @Field(() => [EventsUpdateManyWithWhereWithoutBadgesInput], {nullable:true})
