...
import { TeamMembersUncheckedUpdateManyWithoutTeamsInput } from '../team-members/team-members-unchecked-update-many-without-teams.input';

@InputType()
export class TeamsUncheckedUpdateInput {
    ...
    @Field(() => TeamMembersUncheckedUpdateManyWithoutTeamsInput, {nullable:true})
    teamMembers?: TeamMembersUncheckedUpdateManyWithoutTeamsInput;
}
