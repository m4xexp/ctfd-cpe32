...
import { TeamMembersUpdateManyWithoutTeamsInput } from '../team-members/team-members-update-many-without-teams.input'

@InputType()
export class TeamsUpdateInput {
  ...
  @Field(() => TeamMembersUpdateManyWithoutTeamsInput, { nullable: true })
  teamMembers?: TeamMembersUpdateManyWithoutTeamsInput
}
