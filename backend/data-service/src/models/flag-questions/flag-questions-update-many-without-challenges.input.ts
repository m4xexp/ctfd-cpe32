...
@InputType()
export class FlagQuestionsUpdateManyWithoutChallengesInput {
    ...
    @Field(() => [FlagQuestionsUpsertWithWhereUniqueWithoutChallengesInput], {nullable:true})
    ...
    @Field(() => [FlagQuestionsUpdateWithWhereUniqueWithoutChallengesInput], {nullable:true})
    update?: Array<FlagQuestionsUpdateWithWhereUniqueWithoutChallengesInput>;

    @Field(() => [FlagQuestionsUpdateManyWithWhereWithoutChallengesInput], {nullable:true})
