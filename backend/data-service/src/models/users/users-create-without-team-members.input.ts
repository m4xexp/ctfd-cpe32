...
import { UserLoggingsCreateNestedManyWithoutUsersInput } from '../user-loggings/user-loggings-create-nested-many-without-users.input'
...
@InputType()
export class UsersCreateWithoutTeamMembersInput {
  ...
  @Field(() => UserLoggingsCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
  ...
  @Field(() => UserTutorialsCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
