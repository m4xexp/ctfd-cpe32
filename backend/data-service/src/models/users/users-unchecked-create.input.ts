...
import { TeamMembersUncheckedCreateNestedManyWithoutUsersInput } from '../team-members/team-members-unchecked-create-nested-many-without-users.input';
...
export class UsersUncheckedCreateInput {
    ...
    @Field(() => UserLoggingsUncheckedCreateNestedManyWithoutUsersInput, {nullable:true})
    userLoggings?: UserLoggingsUncheckedCreateNestedManyWithoutUsersInput;

    @Field(() => UserBadgesUncheckedCreateNestedManyWithoutUsersInput, {nullable:true})
    userBadges?: UserBadgesUncheckedCreateNestedManyWithoutUsersInput;

    @Field(() => TeamMembersUncheckedCreateNestedManyWithoutUsersInput, {nullable:true})
    teamMembers?: TeamMembersUncheckedCreateNestedManyWithoutUsersInput;

    @Field(() => UserTutorialsUncheckedCreateNestedManyWithoutUsersInput, {nullable:true})
    userTutorials?: UserTutorialsUncheckedCreateNestedManyWithoutUsersInput;

    @Field(() => UserScoresUncheckedCreateNestedManyWithoutUsersInput, {nullable:true})
