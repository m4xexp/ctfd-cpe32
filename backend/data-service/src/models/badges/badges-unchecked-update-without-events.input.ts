...
@InputType()
export class BadgesUncheckedUpdateWithoutEventsInput {
  ...
  @Field(() => UserBadgesUncheckedUpdateManyWithoutBadgesInput, {
    nullable: true,
  })
  userBadges?: UserBadgesUncheckedUpdateManyWithoutBadgesInput

  @Field(() => ChallengesUncheckedUpdateManyWithoutBadgesInput, {
    nullable: true,
  })
