...
@InputType()
export class BadgesUncheckedCreateInput {
  ...
  @Field(() => UserBadgesUncheckedCreateNestedManyWithoutBadgesInput, {
    nullable: true,
  })
  userBadges?: UserBadgesUncheckedCreateNestedManyWithoutBadgesInput

  @Field(() => EventsUncheckedCreateNestedManyWithoutBadgesInput, {
    nullable: true,
  })
  events?: EventsUncheckedCreateNestedManyWithoutBadgesInput

  @Field(() => ChallengesUncheckedCreateNestedManyWithoutBadgesInput, {
    nullable: true,
  })
