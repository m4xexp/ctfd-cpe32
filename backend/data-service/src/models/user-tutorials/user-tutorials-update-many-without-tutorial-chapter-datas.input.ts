...
@InputType()
export class UserTutorialsUpdateManyWithoutTutorialChapterDatasInput {
  @Field(() => [UserTutorialsCreateWithoutTutorialChapterDatasInput], {
    nullable: true,
  })
  create?: Array<UserTutorialsCreateWithoutTutorialChapterDatasInput>

  @Field(() => [UserTutorialsCreateOrConnectWithoutTutorialChapterDatasInput], {
    nullable: true,
  })
  connectOrCreate?: Array<UserTutorialsCreateOrConnectWithoutTutorialChapterDatasInput>

  @Field(
    () => [UserTutorialsUpsertWithWhereUniqueWithoutTutorialChapterDatasInput],
    { nullable: true },
  )
  upsert?: Array<UserTutorialsUpsertWithWhereUniqueWithoutTutorialChapterDatasInput>

  @Field(() => UserTutorialsCreateManyTutorialChapterDatasInputEnvelope, {
    nullable: true,
  })
  ...
  @Field(
    () => [UserTutorialsUpdateWithWhereUniqueWithoutTutorialChapterDatasInput],
    { nullable: true },
  )
  update?: Array<UserTutorialsUpdateWithWhereUniqueWithoutTutorialChapterDatasInput>

  @Field(
    () => [UserTutorialsUpdateManyWithWhereWithoutTutorialChapterDatasInput],
    { nullable: true },
  )
