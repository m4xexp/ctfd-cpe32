...
@InputType()
export class UserTutorialsCreateInput {
    ...
    @Field(() => UsersCreateNestedOneWithoutUserTutorialsInput, {nullable:false})
    users!: UsersCreateNestedOneWithoutUserTutorialsInput;

    @Field(() => TutorialChapterDatasCreateNestedOneWithoutUserTutorialsInput, {nullable:false})
