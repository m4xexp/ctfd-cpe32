...
@InputType()
export class UserTutorialsUpdateManyWithoutUsersInput {
  ...
  @Field(() => [UserTutorialsUpsertWithWhereUniqueWithoutUsersInput], {
    nullable: true,
  })
  ...
  @Field(() => [UserTutorialsUpdateWithWhereUniqueWithoutUsersInput], {
    nullable: true,
  })
  update?: Array<UserTutorialsUpdateWithWhereUniqueWithoutUsersInput>

  @Field(() => [UserTutorialsUpdateManyWithWhereWithoutUsersInput], {
    nullable: true,
  })
