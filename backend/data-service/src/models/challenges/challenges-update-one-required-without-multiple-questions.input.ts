...
export class ChallengesUpdateOneRequiredWithoutMultipleQuestionsInput {
    ...
    @Field(() => ChallengesCreateWithoutMultipleQuestionsInput, {nullable:true})
    create?: ChallengesCreateWithoutMultipleQuestionsInput;

    @Field(() => ChallengesCreateOrConnectWithoutMultipleQuestionsInput, {nullable:true})
    connectOrCreate?: ChallengesCreateOrConnectWithoutMultipleQuestionsInput;

    @Field(() => ChallengesUpsertWithoutMultipleQuestionsInput, {nullable:true})
    ...
    @Field(() => ChallengesUpdateWithoutMultipleQuestionsInput, {nullable:true})
