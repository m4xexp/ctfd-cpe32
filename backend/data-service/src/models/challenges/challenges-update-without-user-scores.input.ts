...
import { TypesUpdateOneRequiredWithoutChallengesInput } from '../types/types-update-one-required-without-challenges.input';
...
@InputType()
export class ChallengesUpdateWithoutUserScoresInput {
    ...
    @Field(() => LevelsUpdateOneRequiredWithoutChallengesInput, {nullable:true})
    levels?: LevelsUpdateOneRequiredWithoutChallengesInput;

    @Field(() => TypesUpdateOneRequiredWithoutChallengesInput, {nullable:true})
    types?: TypesUpdateOneRequiredWithoutChallengesInput;

    @Field(() => CategoriesUpdateOneRequiredWithoutChallengesInput, {nullable:true})
    categories?: CategoriesUpdateOneRequiredWithoutChallengesInput;

    @Field(() => BadgesUpdateOneRequiredWithoutChallengesInput, {nullable:true})
    badges?: BadgesUpdateOneRequiredWithoutChallengesInput;

    @Field(() => MultipleQuestionsUpdateManyWithoutChallengesInput, {nullable:true})
    multipleQuestions?: MultipleQuestionsUpdateManyWithoutChallengesInput;

    @Field(() => ShortAnswerQuestionsUpdateManyWithoutChallengesInput, {nullable:true})
    shortAnswerQuestions?: ShortAnswerQuestionsUpdateManyWithoutChallengesInput;

    @Field(() => FlagQuestionsUpdateManyWithoutChallengesInput, {nullable:true})
