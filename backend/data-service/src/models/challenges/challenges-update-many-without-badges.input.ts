...
export class ChallengesUpdateManyWithoutBadgesInput {
  ...
  @Field(() => [ChallengesUpdateWithWhereUniqueWithoutBadgesInput], {
    nullable: true,
  })
  update?: Array<ChallengesUpdateWithWhereUniqueWithoutBadgesInput>

  @Field(() => [ChallengesUpdateManyWithWhereWithoutBadgesInput], {
    nullable: true,
  })
