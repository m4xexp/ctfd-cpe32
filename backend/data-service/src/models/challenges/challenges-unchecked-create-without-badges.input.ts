...
@InputType()
export class ChallengesUncheckedCreateWithoutBadgesInput {
  ...
  @Field(() => UserScoresUncheckedCreateNestedManyWithoutChallengesInput, {
    nullable: true,
  })
  userScores?: UserScoresUncheckedCreateNestedManyWithoutChallengesInput

  @Field(
    () => MultipleQuestionsUncheckedCreateNestedManyWithoutChallengesInput,
    { nullable: true },
  )
  multipleQuestions?: MultipleQuestionsUncheckedCreateNestedManyWithoutChallengesInput

  @Field(
    () => ShortAnswerQuestionsUncheckedCreateNestedManyWithoutChallengesInput,
    { nullable: true },
  )
  shortAnswerQuestions?: ShortAnswerQuestionsUncheckedCreateNestedManyWithoutChallengesInput

  @Field(() => FlagQuestionsUncheckedCreateNestedManyWithoutChallengesInput, {
    nullable: true,
  })
