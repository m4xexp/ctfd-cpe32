...
@InputType()
export class ChallengesUncheckedUpdateManyWithoutCategoriesInput {
    ...
    @Field(() => [ChallengesUpsertWithWhereUniqueWithoutCategoriesInput], {nullable:true})
    ...
    @Field(() => [ChallengesUpdateWithWhereUniqueWithoutCategoriesInput], {nullable:true})
    update?: Array<ChallengesUpdateWithWhereUniqueWithoutCategoriesInput>;

    @Field(() => [ChallengesUpdateManyWithWhereWithoutCategoriesInput], {nullable:true})
