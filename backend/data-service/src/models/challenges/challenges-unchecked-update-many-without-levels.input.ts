...
@InputType()
export class ChallengesUncheckedUpdateManyWithoutLevelsInput {
    ...
    @Field(() => [ChallengesUpsertWithWhereUniqueWithoutLevelsInput], {nullable:true})
    ...
    @Field(() => [ChallengesUpdateWithWhereUniqueWithoutLevelsInput], {nullable:true})
    update?: Array<ChallengesUpdateWithWhereUniqueWithoutLevelsInput>;

    @Field(() => [ChallengesUpdateManyWithWhereWithoutLevelsInput], {nullable:true})
