...
@InputType()
export class ChallengesUncheckedUpdateWithoutCategoriesInput {
    ...
    @Field(() => UserScoresUncheckedUpdateManyWithoutChallengesInput, {nullable:true})
    userScores?: UserScoresUncheckedUpdateManyWithoutChallengesInput;

    @Field(() => MultipleQuestionsUncheckedUpdateManyWithoutChallengesInput, {nullable:true})
    multipleQuestions?: MultipleQuestionsUncheckedUpdateManyWithoutChallengesInput;

    @Field(() => ShortAnswerQuestionsUncheckedUpdateManyWithoutChallengesInput, {nullable:true})
    shortAnswerQuestions?: ShortAnswerQuestionsUncheckedUpdateManyWithoutChallengesInput;

    @Field(() => FlagQuestionsUncheckedUpdateManyWithoutChallengesInput, {nullable:true})
