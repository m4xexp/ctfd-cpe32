...
export class ChallengesUpdateOneRequiredWithoutShortAnswerQuestionsInput {
    ...
    @Field(() => ChallengesCreateWithoutShortAnswerQuestionsInput, {nullable:true})
    create?: ChallengesCreateWithoutShortAnswerQuestionsInput;

    @Field(() => ChallengesCreateOrConnectWithoutShortAnswerQuestionsInput, {nullable:true})
    connectOrCreate?: ChallengesCreateOrConnectWithoutShortAnswerQuestionsInput;

    @Field(() => ChallengesUpsertWithoutShortAnswerQuestionsInput, {nullable:true})
    ...
    @Field(() => ChallengesUpdateWithoutShortAnswerQuestionsInput, {nullable:true})
