...
@InputType()
export class ShortAnswerQuestionsUpdateManyWithoutChallengesInput {
    ...
    @Field(() => [ShortAnswerQuestionsUpsertWithWhereUniqueWithoutChallengesInput], {nullable:true})
    ...
    @Field(() => [ShortAnswerQuestionsUpdateWithWhereUniqueWithoutChallengesInput], {nullable:true})
    update?: Array<ShortAnswerQuestionsUpdateWithWhereUniqueWithoutChallengesInput>;

    @Field(() => [ShortAnswerQuestionsUpdateManyWithWhereWithoutChallengesInput], {nullable:true})
