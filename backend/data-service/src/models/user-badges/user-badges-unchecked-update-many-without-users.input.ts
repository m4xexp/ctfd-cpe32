...
@InputType()
export class UserBadgesUncheckedUpdateManyWithoutUsersInput {
    ...
    @Field(() => [UserBadgesUpsertWithWhereUniqueWithoutUsersInput], {nullable:true})
    ...
    @Field(() => [UserBadgesUpdateWithWhereUniqueWithoutUsersInput], {nullable:true})
    update?: Array<UserBadgesUpdateWithWhereUniqueWithoutUsersInput>;

    @Field(() => [UserBadgesUpdateManyWithWhereWithoutUsersInput], {nullable:true})
