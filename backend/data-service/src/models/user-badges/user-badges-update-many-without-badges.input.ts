...
export class UserBadgesUpdateManyWithoutBadgesInput {
  ...
  @Field(() => [UserBadgesUpdateWithWhereUniqueWithoutBadgesInput], {
    nullable: true,
  })
  update?: Array<UserBadgesUpdateWithWhereUniqueWithoutBadgesInput>

  @Field(() => [UserBadgesUpdateManyWithWhereWithoutBadgesInput], {
    nullable: true,
  })
