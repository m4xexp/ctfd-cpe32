...
@InputType()
export class TeamMembersUpdateManyWithoutUsersInput {
  ...
  @Field(() => [TeamMembersUpsertWithWhereUniqueWithoutUsersInput], {
    nullable: true,
  })
  ...
  @Field(() => [TeamMembersUpdateWithWhereUniqueWithoutUsersInput], {
    nullable: true,
  })
  update?: Array<TeamMembersUpdateWithWhereUniqueWithoutUsersInput>

  @Field(() => [TeamMembersUpdateManyWithWhereWithoutUsersInput], {
    nullable: true,
  })
