...
@InputType()
export class TeamMembersUpdateManyWithoutTeamsInput {

    @Field(() => [TeamMembersCreateWithoutTeamsInput], {nullable:true})
    create?: Array<TeamMembersCreateWithoutTeamsInput>;

    @Field(() => [TeamMembersCreateOrConnectWithoutTeamsInput], {nullable:true})
    connectOrCreate?: Array<TeamMembersCreateOrConnectWithoutTeamsInput>;

    @Field(() => [TeamMembersUpsertWithWhereUniqueWithoutTeamsInput], {nullable:true})
    ...
    @Field(() => [TeamMembersUpdateWithWhereUniqueWithoutTeamsInput], {nullable:true})
    update?: Array<TeamMembersUpdateWithWhereUniqueWithoutTeamsInput>;

    @Field(() => [TeamMembersUpdateManyWithWhereWithoutTeamsInput], {nullable:true})
