...
export class UserLoggingsUpdateManyWithoutUsersInput {
  ...
  @Field(() => [UserLoggingsUpdateWithWhereUniqueWithoutUsersInput], {
    nullable: true,
  })
  update?: Array<UserLoggingsUpdateWithWhereUniqueWithoutUsersInput>

  @Field(() => [UserLoggingsUpdateManyWithWhereWithoutUsersInput], {
    nullable: true,
  })
