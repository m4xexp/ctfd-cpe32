...
@InputType()
export class UserScoresUpdateWithoutChallengesInput {
  ...
  @Field(() => LevelsUpdateOneRequiredWithoutUserScoresInput, {
    nullable: true,
  })
  ...
  @Field(() => CategoriesUpdateOneRequiredWithoutUserScoresInput, {
    nullable: true,
  })
