...
export class UserScoresUncheckedUpdateManyWithoutCategoriesInput {
  ...
  @Field(() => [UserScoresUpdateWithWhereUniqueWithoutCategoriesInput], {
    nullable: true,
  })
  update?: Array<UserScoresUpdateWithWhereUniqueWithoutCategoriesInput>

  @Field(() => [UserScoresUpdateManyWithWhereWithoutCategoriesInput], {
    nullable: true,
  })
