...
@InputType()
export class UserScoresUncheckedUpdateManyWithoutLevelsInput {
  ...
  @Field(() => [UserScoresUpsertWithWhereUniqueWithoutLevelsInput], {
    nullable: true,
  })
  ...
  @Field(() => [UserScoresUpdateWithWhereUniqueWithoutLevelsInput], {
    nullable: true,
  })
  update?: Array<UserScoresUpdateWithWhereUniqueWithoutLevelsInput>

  @Field(() => [UserScoresUpdateManyWithWhereWithoutLevelsInput], {
    nullable: true,
  })
