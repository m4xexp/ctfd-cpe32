...
@InputType()
export class UserScoresUpdateManyWithoutUsersInput {
    ...
    @Field(() => [UserScoresUpsertWithWhereUniqueWithoutUsersInput], {nullable:true})
    ...
    @Field(() => [UserScoresUpdateWithWhereUniqueWithoutUsersInput], {nullable:true})
    update?: Array<UserScoresUpdateWithWhereUniqueWithoutUsersInput>;

    @Field(() => [UserScoresUpdateManyWithWhereWithoutUsersInput], {nullable:true})
