...
@InputType()
export class UserScoresUpdateManyWithoutTypesInput {
  ...
  @Field(() => [UserScoresUpsertWithWhereUniqueWithoutTypesInput], {
    nullable: true,
  })
  ...
  @Field(() => [UserScoresUpdateWithWhereUniqueWithoutTypesInput], {
    nullable: true,
  })
  update?: Array<UserScoresUpdateWithWhereUniqueWithoutTypesInput>

  @Field(() => [UserScoresUpdateManyWithWhereWithoutTypesInput], {
    nullable: true,
  })
