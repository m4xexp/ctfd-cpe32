...
@InputType()
export class UserScoresUpdateManyWithoutChallengesInput {
  ...
  @Field(() => [UserScoresUpsertWithWhereUniqueWithoutChallengesInput], {
    nullable: true,
  })
  ...
  @Field(() => [UserScoresUpdateWithWhereUniqueWithoutChallengesInput], {
    nullable: true,
  })
  update?: Array<UserScoresUpdateWithWhereUniqueWithoutChallengesInput>

  @Field(() => [UserScoresUpdateManyWithWhereWithoutChallengesInput], {
    nullable: true,
  })
